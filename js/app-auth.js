...
function authOverlay(html){
  ...
  el.id = 'authOverlay';
  el.style.cssText = 'position:fixed;inset:0;z-index:200;background:var(--bg,#f6f4ee);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;text-align:center;';
  el.innerHTML = html;
